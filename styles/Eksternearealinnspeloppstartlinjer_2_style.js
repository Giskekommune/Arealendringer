...
function categories_Eksternearealinnspeloppstartlinjer_2(feature, value, size, resolution, labelText,
                ...
                switch(valueStr) {case 'tilrådast':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(51,160,44,1.0)', lineDash: null, lineCap: 'round', lineJoin: 'round', width: 4.028}),
...
var style_Eksternearealinnspeloppstartlinjer_2 = function(feature, resolution){
    ...
    var labelText = ""; 
    var value = feature.get("ResultatKU");
